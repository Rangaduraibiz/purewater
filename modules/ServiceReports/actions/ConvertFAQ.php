...
class ServiceReports_ConvertFAQ_Action extends Vtiger_Action_Controller {
	...
	public function process(Vtiger_Request $request) {
		...
		if (!empty ($recordId)) {
			...
			$faqRecordModel = Faq_Record_Model::getInstanceFromServiceReport($recordModel);
			...
			if ($answer) {
				try {
					...
					$requestData['module'] = 'ServiceReports';
				...
				header("Location: ".$faqRecordModel->getEditViewUrl()."&parentId=$recordId&parentModule=$moduleName&loki=koki");
			}
		}
	}
