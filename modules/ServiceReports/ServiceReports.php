...
class ServiceReports extends CRMEntity {
    ...
    var $tab_name = Array('vtiger_crmentity', 'vtiger_servicereports', 'vtiger_servicereportscf',
     'vtiger_inventoryproductrel','vtiger_servicereports_other','vtiger_inventoryproductrel_other','vtiger_inventoryproductrel_other_masn');
