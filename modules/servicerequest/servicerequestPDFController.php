...
class Vtiger_servicerequestPDFController extends Vtiger_InventoryPDFController{
	function buildHeaderModelTitle() {
		...
		return sprintf("%s: %s", $translatedSingularModuleLabel, $this->focusColumnValue('servicerequest_no'));
	}
	...
	function getWatermarkContent() {
		return $this->focusColumnValue('servicerequeststatus');
	}
}
?>
