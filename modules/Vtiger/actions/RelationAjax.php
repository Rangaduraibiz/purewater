...
class Vtiger_RelationAjax_Action extends Vtiger_Action_Controller {
	...
	function addRelation($request) {
		...
		if ($sourceModule == 'ServiceEngineer' && $relatedModule == 'FunctionalLocations') {
			...
			$relquery=$adb->pquery("SELECT service_engineer_name,badge_no,designaion,regional_office,district_office
			 FROM `vtiger_serviceengineer` where serviceengineerid=".$sourceRecordId);
