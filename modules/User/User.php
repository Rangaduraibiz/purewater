...
class User extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_user';
	var $table_index= 'userid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_usercf', 'userid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_user', 'vtiger_usercf');
