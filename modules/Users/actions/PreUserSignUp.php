...
class Users_PreUserSignUp_Action extends Vtiger_Action_Controller {
    ...
    function process(Vtiger_Request $request) {
        ...
        if (!empty($badgeNoAndMobile)) {
            if (isset($badgeNoAndMobile['email']) && !empty($badgeNoAndMobile['email']) && $badgeNo == $badgeNoAndMobile['email']) {
        ...
        if (!empty($emailId)) {
            ...
            $handler_data = [];
            $activeFields = $this->getActiveFields('Empolyee', true);
            ...
            foreach ($activeFieldKeys as $activeFieldKey) {
                if ($activeFieldKey == 'assigned_user_id') {
                    ...
                    // if ($activeFieldKey == 'confirm_password' || $activeFieldKey == 'password') {
