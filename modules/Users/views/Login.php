	...
	function process (Vtiger_Request $request) {
		...
		if ($error) {
			switch ($error) {
				...
				case 'platformerror'	:	$message = 'You Are Not Allowed To Login From Web';	break;
				case 'noRegistration'	:	$message = 'You Are Not Registered';	break;
				case 'approvalPending'	:	$message = 'User Verfication Is Pending';	break;
				case 'approvalRejected'	:	$message = 'User Verfication Is Rejected , Please Sign Up Again';	break;
			}
		} else if ($mailStatus) {
