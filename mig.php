...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $field->setPicklistValues(array(
            'On leave / Will be on leave',
            'On training',
            'Already more than 5 pending Service Request',
            'Need Electrical expert to attend the Service Request',
            'Need Mechanical/Hydraulic/Engine expert to attend the Service Request',
            'Working on other Service request & too far from the Customer location',
            'Assistance provided to customer over call and rectified',
            'Not a valid Service Request.'
        ));
    } else {
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('bg_initial_vl_st_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'bg_initial_vl_st_date';
        $fieldInstance->label = 'Intial Validity Start Date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'bg_initial_vl_st_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- bg_initial_vl_st_date in BankGuarantee Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('bg_initial_vl_en_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'bg_initial_vl_en_date';
        $fieldInstance->label = 'Initial Validity End Date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'bg_initial_vl_en_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- bg_initial_vl_en_date in BankGuarantee Module --- <br>";
    }
} else {
    echo "block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $fieldInstance->label = 'Extended Validity Start Date';
        $fieldInstance->table = $moduleInstance->basetable;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'reason_for_ext';
        $fieldInstance->label = 'Reason for Extension';
        $fieldInstance->table = $invoiceModule->basetable;
        $fieldInstance->column = 'reason_for_ext';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('Availability Under Reconciliation', 
        'Delay In Commissioning', 
        'Delay In Supply Of Initial Spare Parts'));
    } else {
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- failure_time in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Equipment Details -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- tck_det_purpose in ServiceReports Module --- <br>";
    }
} else {
...
//     } else {
//         echo "field is already Present --- wt_war_start_cond in ServiceReports Module --- <br>";
//     }
// } else {
//     echo "block does not exits --- Warranty_Terms in ServiceReports-- <br>";
// }
// $moduleInstance = null;
// $blockInstance = null;
// $fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- mt_major_aggrts in ServiceReports Module --- <br>";
    }
} else {
    echo "block does not exits --- Maintenance_Details in ServiceReports-- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- mt_pdical_maint_type in ServiceReports Module --- <br>";
    }
} else {
    echo "block does not exits --- Maintenance_Details in ServiceReports-- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- mod_of_sub_ambly in ServiceReports Module --- <br>";
    }
} else {
    echo "block does not exits --- Sub_Assembly_Details in ServiceReports-- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- saspd_po_detail in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Sub_Assembly_Spares_Parts_Details in ServiceReports -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- saspd_dod in ServiceReports Module --- <br>";
    }
} else {
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- saspd_pod in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Sub_Assembly_Spares_Parts_Details -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- td_symptoms ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Ticket Details in ServiceReports -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- action_taken_block_seo In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- ACTION_TAKEN -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sad_det_of_subasmb in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Sub_Assembly_Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- manual_equ_ser in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Equipment Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- lid_manual_sl in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_ITEM_DETAILS in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- lid_rejected_qty in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ITEM_DETAILS in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- lid_remarks in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_ITEM_DETAILS in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- lid_po_qty in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ITEM_DETAILS in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $fieldInstance->name = 'war_claim_dte';
        $fieldInstance->label = 'war_claim_dte';
        $fieldInstance->table = 'vtiger_servicereports_other';
        $fieldInstance->column = 'war_claim_dte';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        ...
        echo "field is already Present --- war_claim_dte in ServiceReports Module --- <br>";
    }
} else {
    echo "block does not exits --- Ticket Details   -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_hmr in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Sub_Assembly_Details  in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $field->uitype = 2;
        $field->table = 'vtiger_servicereports_other';
        ...
        echo "field is present -- chassis_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- chassis_manufacturer ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- engine_lh_rh_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- engine_lh_rh_mfd ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- transmission_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- transmission_manufacturer ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_line_status in ServiceReports Module --- <br>";
    }
} else {
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_line_event in ServiceReports Module --- <br>";
    }
} else {
    echo "block does not exits --- Shortages_And_Damages   -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sad_line_dnsoc In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- Shortages_And_Damages in ServiceReports -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- rear_axle_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- rear_axle_manufacturer ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- tandem_assembly_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- tandem_assembly_manufacturer ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- rh_final_drive_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- rh_final_drive_manu ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- lh_final_drive_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- lh_final_drive_manufacturer ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- induction_motorsl_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- induction_motor_manuf ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- track_drive_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- track_drive_manuf ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- front_axle_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- ecd_can_be_com in ServiceReports Module --- <br>";
    }
} else {
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- vendor_item in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ITEM_DETAILS -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_war_start_con in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_type_of_sub_ass in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_war_term in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_war_term_app in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_date_oracs in ServiceReports Module --- <br>";
    }
} else {
    echo "block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_podate in ServiceReports Module --- <br>";
    }
} else {
    echo "block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sad_sub_ass_sl In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sad_sub_ass_po_det In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_su_ass_srp in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_su_ass_mod_srp in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_sub_ass_mon in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_sub_ass_hmr in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_sub_ass_km in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- at_sais in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- ACTION_TAKEN -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- at_on_account_of in ServiceReports Module --- <br>";
    }
} else {
    echo "Block does not exits --- ACTION_TAKEN -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- at_dm_status in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- ACTION_TAKEN -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- reason_for_not_completion ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- ACTION_TAKEN in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- reason_for_modification ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Design_Modification_Details in ServiceReports -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- refer_for_modif ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Design_Modification_Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- dmd_system in ServiceReports Module --- <br>";
    }
} else {
...
//         $blockInstance->addField($field);
//     } else {
//         echo "field is present -- add_for_cre_so In ServiceReports Module --- <br>";
//     }
// } else {
//     echo "Block Does not exits -- LBL_ITEM_DETAILS in ServiceReports -- <br>";
// }
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- war_warable in ServiceReports Module --- <br>";
    }
} else {
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- eq_last_hmr in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Warrrantable in ServiceReports -- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- eq_sta_aft_act_t_sub in ServiceReports Module --- <br>";
    }
} else {
    echo "Block does not exits --- ACTION_TAKEN -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- at_brkdn_sr_req in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- ACTION_TAKEN -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- breack_ticket_id  in ServiceReports--- <br>";
    }
} else {
    echo "Block Does not exits -- ACTION_TAKEN in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sr_final_drive_wt ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Warranty / Contract Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sr_engine_wt ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Warranty / Contract Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sr_transmission_wt ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Warranty / Contract Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sr_rear_axle_wt ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Warranty / Contract Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sr_chassis_wt  ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Warranty / Contract Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- line_vendor_id  in ServiceReports--- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_ITEM_DETAILS in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- front_axle_manufact ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- genchk_oil_pre_tr in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- GENERAL_CHECKS -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- genchk_oil_tr_tem in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- GENERAL_CHECKS -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- genchk_brk_oil_tem in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- GENERAL_CHECKS -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- at_copm in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- ACTION_TAKEN -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- lid_msr In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_ITEM_DETAILS in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- saspd_doc in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Equipment_Commissioning_details -- <br>";
}
...
if ($blockInstance) {
    ...
    echo "Block Does not exits -- ServiceOrders in ServiceReports -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- lid_line_event in ServiceReports Module --- <br>";
    }
} else {
    echo "block does not exits --- LBL_ITEM_DETAILS   -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sacfd_dofcf in ServiceReports Module --- <br>";
    }
} else {
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sacfd_eq_sl_no in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Sub_Assembly_Commissioning_Fitment_details in ServiceReports -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sacfd_km_run in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Sub_Assembly_Commissioning_Fitment_details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sad_manu_name ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Shortages_And_Damages in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_whoa in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_dof in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_valid_sl_no in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sad_ag_sl_no ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Shortages_And_Damages in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_sel_ag_name in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- eq_present_km in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Warrrantable in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_dofcf in ServiceReports Module --- <br>";
    }
} else {
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_km_run in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Sub_Assembly_Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $tom = "INSERT INTO `vtiger_fieldmodulerel` (`fieldid`, `module`, `relmodule`, `status`, `sequence`) VALUES ('$id', 'ServiceReports', 'DeliveryNotes', NULL, NULL)";
        $adb->pquery($tom);
    } else {
        echo "field is present -- equip_id_da_sr  in ServiceReports--- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_CUSTOM_INFORMATION in ServiceReports -- <br>";
}
...
// $blockInstance = Vtiger_Block::getInstance('LBL_USERLOGIN_ROLE', $invoiceModule);
// if ($blockInstance) {
//     $fieldInstance = Vtiger_Field::getInstance('is_usr_crted', $invoiceModule);
//     if (!$fieldInstance) {
//         $field = new Vtiger_Field();
//         $field->name = 'is_usr_crted';
//         $field->column = 'is_usr_crted';
//         $field->table = $invoiceModule->basetable;
//         $field->label = 'Is User Created?';
//         $field->uitype = 56;
//         $field->columntype = 'INT(1) DEFAULT 0';
//         $field->typeofdata = 'I~O';
//         $field->displaytype = 2;
//         $blockInstance->addField($field);
//     } else {
//         echo "field is present -- is_usr_crted In ServiceEngineer Module --- <br>";
//     }
// } else {
//     echo "Block Does not exits -- LBL_USERLOGIN_ROLE in ServiceEngineer -- <br>";
// }
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- genchk_oil_level_swc in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- GENERAL_CHECKS -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- genchk_lub_swc in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- GENERAL_CHECKS -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- genchk_coolant_lvl_swc in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- GENERAL_CHECKS -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sacfd_wasawbfise in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Equipment_Commissioning_details -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- masn_aggrregate in ServiceReports Module --- <br>";
    }
} else {
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- masn_aggre_sl ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- masn_manu ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- vis_chk_painting In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- VISUAL_CHECKS in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- vis_chk_painting_rem In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- VISUAL_CHECKS -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- vis_chk_painting_doc in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- VISUAL_CHECKS in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sad_ser_no in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Sub_Assembly_Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_nl_war_term_app in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Sub_Assembly_Details -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- sad_po_detail in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Sub_Assembly_Details in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- sad_po_date in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Sub_Assembly_Details -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- masn_other_manu ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Major_Aggregates_Sl_No in ServiceReports -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- apmd_peridic_maint_type in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Shortages_And_Damages -- <br>";
}
...
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('FailedParts', 'UpdatePendingDays'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("FailedParts", "UpdatePendingDays", "modules/FailedParts/UpdatePendingDays.php", "UpdatePendingDays");
} else {
    print_r("already exits --- workflow function -- UpdatePendingDays <br> ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('bg_initial_cl_st_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'bg_initial_cl_st_date';
        $fieldInstance->label = 'Intial Claim start date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'bg_initial_cl_st_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- bg_initial_cl_st_date in BankGuarantee Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('bg_initial_cl_end_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'bg_initial_cl_end_date';
        $fieldInstance->label = 'Intial Claim End Date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'bg_initial_cl_end_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- bg_initial_cl_end_date in BankGuarantee Module --- <br>";
    }
} else {
    echo "block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('bg_extended_cl_st_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'bg_extended_cl_st_date';
        $fieldInstance->label = 'Extended claim Start Date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'bg_extended_cl_st_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- bg_extended_cl_st_date in BankGuarantee Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('bg_extended_cl_end_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'bg_extended_cl_end_date';
        $fieldInstance->label = 'Extended claim End Date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'bg_extended_cl_end_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- bg_extended_cl_end_date in BankGuarantee Module --- <br>";
    }
} else {
    echo "block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('EquipmentAvailability', 'EquipmentAvailabilityCalculation'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("EquipmentAvailability", "EquipmentAvailabilityCalculation", "modules/EquipmentAvailability/EquipmentAvailabilityCalculation.php", "EquipmentAvailabilityCalculation");
} else {
    print_r("already exits --- workflow function -- EquipmentAvailabilityCalculation <br> ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('shift_hours', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'shift_hours';
        $fieldInstance->label = 'Shift Hours';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'shift_hours';
        $fieldInstance->uitype = '999';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        ...
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('24', '16'));
    } else {
        echo "field is already Present --- shift_hours in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('beml_total_breakdown', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'beml_total_breakdown';
        $fieldInstance->column = 'beml_total_breakdown';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'BreakDown Under BEML Account';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- beml_total_breakdown in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('cust_total_breakdown', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'cust_total_breakdown';
        $fieldInstance->column = 'cust_total_breakdown';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'BreakDown Under Customer Account';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- cust_total_breakdown in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('cust_maint_hours', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'cust_maint_hours';
        $fieldInstance->column = 'cust_maint_hours';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'M.H.Under Customer Account';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- cust_maint_hours in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('beml_maint_hours', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'beml_maint_hours';
        $fieldInstance->column = 'beml_maint_hours';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'M.H.Under BEML Account';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- beml_maint_hours in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('total_maint_hours', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'total_maint_hours';
        $fieldInstance->column = 'total_maint_hours';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Total Maintainence Hours';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- total_maint_hours in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('cust_maint_hour_cons', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'cust_maint_hour_cons';
        $fieldInstance->label = 'cust_maint_hour_cons';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'cust_maint_hour_cons';
        $fieldInstance->uitype = '999';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(10)';
        ...
        echo "field is already Present --- cust_maint_hour_cons in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('idle_hours', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'idle_hours';
        $fieldInstance->column = 'idle_hours';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Idle Hours';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- idle_hours in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('worked_hours', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'worked_hours';
        $fieldInstance->column = 'worked_hours';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Worked Hours';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'NN~O';
        $fieldInstance->columntype = 'DECIMAL(10,5)';
        ...
        echo "field is already Present --- worked_hours in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('bg_availabilty_status', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'bg_availabilty_status';
        $fieldInstance->label = 'Availabilty Status';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'bg_availabilty_status';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('Availibilty Reconciliation Under Progress', 
        'Availability Achieved And Under Sigining', 
        'Avilabilty Not Achieved But Under Signing',
        'Availability Wiil Be Reconciled After Completetion Of Contract',
        'Availability Report Signed'));
    } else {
        echo "field is already Present --- bg_availabilty_status in BankGuarantee Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_GENERAL_INFORMATION in BankGuarantee -- <br>";
}
...
$result = $adb->pquery("SELECT fail_pa_pa_status FROM vtiger_fail_pa_pa_status WHERE fail_pa_pa_status=?", array('Validation Pending'));
if ($adb->num_rows($result) == 0) {
    $moduleInstance = Vtiger_Module::getInstance('FailedParts');
    $fieldInstance = Vtiger_Field::getInstance('fail_pa_pa_status', $moduleInstance);
    $fieldInstance->setPicklistValues(array('Validation Pending'));
} else {
    print_r("already exits --- Validation Pending -- drop down value ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_ITEM_DETAILS', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('so_creatable_qty', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'so_creatable_qty';
        $fieldInstance->column = 'so_creatable_qty';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = 'vtiger_inventoryproductrel';
        $fieldInstance->label = 'SalesOrder Creatable Qty';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'I~O';
        $fieldInstance->columntype = 'INT(15)';
        ...
        echo "field is already Present --- so_creatable_qty in FailedParts Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ITEM_DETAILS in FailedParts -- <br>";
}
...
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('SalesOrder', 'ResetSalesOrderCreatedQty'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("SalesOrder", "ResetSalesOrderCreatedQty", "modules/SalesOrder/ResetSalesOrderCreatedQty.php", "ResetSalesOrderCreatedQty");
} else {
    print_r("already exits --- workflow function -- ResetSalesOrderCreatedQty <br> ");
}
$emm = null;

$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('BankGuarantee', 'UpdateAutoStatus'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("BankGuarantee", "UpdateAutoStatus", "modules/BankGuarantee/UpdateAutoStatus.php", "UpdateAutoStatus");
} else {
    print_r("already exits --- workflow function -- UpdateAutoStatus <br> ");
}
$emm = null;

$field = 'bg_issued_to';
$result = $adb->pquery("SELECT $field FROM vtiger_$field WHERE $field=?", array('Equipment'));
if ($adb->num_rows($result) == 0) {
    $moduleInstance = Vtiger_Module::getInstance('BankGuarantee');
    $fieldInstance = Vtiger_Field::getInstance($field, $moduleInstance);
    $fieldInstance->setPicklistValues(array('Equipment'));
} else {
    print_r("already exits --- Equipment -- drop down value ");
}
$emm = null;

$field = 'bg_issued_to';
$result = $adb->pquery("SELECT $field FROM vtiger_$field WHERE $field=?", array('MARC/FMC Contract'));
if ($adb->num_rows($result) == 0) {
    $moduleInstance = Vtiger_Module::getInstance('BankGuarantee');
    $fieldInstance = Vtiger_Field::getInstance($field, $moduleInstance);
    $fieldInstance->setPicklistValues(array('MARC/FMC Contract'));
} else {
    print_r("already exits --- MARC/FMC Contract -- drop down value ");
}
$emm = null;

$field = 'bg_issued_to';
$value = 'Repair/Recon order for aggregates';
$result = $adb->pquery("SELECT $field FROM vtiger_$field WHERE $field=?", array($value));
if ($adb->num_rows($result) == 0) {
    $moduleInstance = Vtiger_Module::getInstance('BankGuarantee');
    $fieldInstance = Vtiger_Field::getInstance($field, $moduleInstance);
    $fieldInstance->setPicklistValues(array($value));
} else {
    print_r("already exits --- $value -- drop down value ");
}
$emm = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $id = $blockInstance->addFieldIgnite($field);
        $invogamoduleInstance = Vtiger_Module::getInstance('FunctionalLocations');
        $relationLabel  = 'BankGuarantee';
        $invogamoduleInstance->setRelatedList(
              $invoiceModule, $relationLabel, Array('ADD'), 'get_dependents_list'
        );
        $tom = "INSERT INTO `vtiger_fieldmodulerel` (`fieldid`, `module`, `relmodule`, `status`, `sequence`) VALUES ('$id', 'BankGuarantee', 'FunctionalLocations', NULL, NULL)";
        $adb->pquery($tom);
    } else {
        echo "field is present -- functional_loc  in BankGuarantee--- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_BLOCK_GENERAL_INFORMATION in BankGuarantee -- <br>";
}
...
$blockInstance = null;
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('ModelAndAggregates');
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $id = $blockInstance->addFieldIgnite($field);
        $invogamoduleInstance = Vtiger_Module::getInstance('ServiceEngineer');
        $relationLabel  = 'ModelAndAggregates';
        $invogamoduleInstance->setRelatedList(
              $invoiceModule, $relationLabel, Array('ADD'), 'get_dependents_list' //you can do select also Array('ADD','SELECT')
        );
        $tom = "INSERT INTO `vtiger_fieldmodulerel` (`fieldid`, `module`, `relmodule`, `status`, `sequence`) VALUES ('$id', 'ModelAndAggregates', 'ServiceEngineer', NULL, NULL)";
        $adb->pquery($tom);
    } else {
        echo "field is present -- service_engineerid  in ModelAndAggregates--- <br>";
    }
} else {
    echo "Block Does not exits -- General Information in ModelAndAggregates -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('Availability For Warranty Period', $moduleInstance);
if ($blockInstance) {
    echo " block does exits --- Availability For Warranty Period   -- <br>";
} else {
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'Availability For Warranty Period';
...
$blockInstance = Vtiger_Block::getInstance('Availability For Warranty Period', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('awp_commited_avl_y', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'awp_commited_avl_y';
        $fieldInstance->column = 'awp_commited_avl_y';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter Committed Availability %';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        $fieldInstance->columntype = 'DECIMAL(7,3)';
        $fieldInstance->quickcreate = 3;
        $fieldInstance->displaytype = 1;
        $blockInstance->addField($fieldInstance);
    } else {
        echo "field is already Present --- awp_commited_avl_y in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- Availability For Warranty Period -- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('Availability For Warranty Period', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('awp_commited_avl_m', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'awp_commited_avl_m';
        $fieldInstance->column = 'awp_commited_avl_m';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter Monthly Availability %';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        $fieldInstance->columntype = 'DECIMAL(7,3)';
        ...
        echo "field is already Present --- awp_commited_avl_m in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- Availability For Warranty Period -- <br>";
}
...
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('afbwcpas', $moduleInstance);
if ($blockInstance) {
    echo " block does not exits --- afbwcpas   -- <br>";
} else {
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'afbwcpas';
    $moduleInstance->addBlock($blockInstance);
}
$moduleInstance = null;
$blockInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('afbwcpas', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('afbwcpas_commited_avl_y', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'afbwcpas_commited_avl_y';
        $fieldInstance->column = 'afbwcpas_commited_avl_y';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter Committed Availability %';
        $fieldInstance->readonly = 1;
        ...
        echo "field is already Present --- afbwcpas_commited_avl_y in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- afbwcpas -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('afbwcpas', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('afbwcpas_commited_avl_m', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'afbwcpas_commited_avl_m';
        $fieldInstance->column = 'afbwcpas_commited_avl_m';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter Monthly Availability %';
        $fieldInstance->readonly = 1;
        ...
        echo "field is already Present --- afbwcpas_commited_avl_m in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- afbwcpas -- <br>";
}
...
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('saatocp', $moduleInstance);
if ($blockInstance) {
    echo " block does not exits --- saatocp   -- <br>";
} else {
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'saatocp';
    $moduleInstance->addBlock($blockInstance);
}
$moduleInstance = null;
$blockInstance = null;
...
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('daadcp', $moduleInstance);
if ($blockInstance) {
    echo " block does not exits --- daadcp   -- <br>";
} else {
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'daadcp';
    $moduleInstance->addBlock($blockInstance);
}
$moduleInstance = null;
$blockInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('saatocp', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('saatocp_commited_avl_y_w', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'saatocp_commited_avl_y_w';
        $fieldInstance->column = 'saatocp_commited_avl_y_w';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter Committed Availability % - Warranty Period';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        $fieldInstance->columntype = 'DECIMAL(7,3)';
        ...
        echo "field is already Present --- saatocp_commited_avl_y_w in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- saatocp -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('saatocp', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('saatocp_commited_avl_m_w', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'saatocp_commited_avl_m_w';
        $fieldInstance->column = 'saatocp_commited_avl_m_w';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter Monthly availability %';
        $fieldInstance->readonly = 1;
        ...
        echo "field is already Present --- saatocp_commited_avl_m_w in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- saatocp -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('saatocp', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('saatocp_commited_avl_y_c', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'saatocp_commited_avl_y_c';
        $fieldInstance->column = 'saatocp_commited_avl_y_c';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter committed Availability % - Contract Period';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        $fieldInstance->columntype = 'DECIMAL(7,3)';
        ...
        echo "field is already Present --- saatocp_commited_avl_y_c in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- saatocp -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('saatocp', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('saatocp_commited_avl_m_c', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'saatocp_commited_avl_m_c';
        $fieldInstance->column = 'saatocp_commited_avl_m_c';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter Monthly Availability %';
        $fieldInstance->readonly = 1;
        ...
        echo "field is already Present --- saatocp_commited_avl_m_c in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- saatocp -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('daadcp', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('daadcp_commited_avl_y_w', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'daadcp_commited_avl_y_w';
        $fieldInstance->column = 'daadcp_commited_avl_y_w';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter Committed Availability % - Warranty Period';
        $fieldInstance->readonly = 1;
        ...
        echo "field is already Present --- daadcp_commited_avl_y_w in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- saatocp -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('daadcp', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('daadcp_commited_avl_m_w', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'daadcp_commited_avl_m_w';
        $fieldInstance->column = 'daadcp_commited_avl_m_w';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Enter Monthly Availability %';
        $fieldInstance->readonly = 1;
        ...
        echo "field is already Present --- daadcp_commited_avl_m_w in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- daadcp -- <br>";
}
...
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('daadcp_lineblock', $moduleInstance);
if ($blockInstance) {
    echo " block does not exits --- daadcp_lineblock   -- <br>";
} else {
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'daadcp_lineblock';
    $moduleInstance->addBlock($blockInstance);
}
$moduleInstance = null;
$blockInstance = null;
...
if (Vtiger_Utils::CheckTable('vtiger_inventoryproductrel_equipment')) {
    print_r("================Table Exits vtiger_inventoryproductrel_equipment ===============");
}  else {
    print_r("================Table Does Not Exits vtiger_inventoryproductrel_equipment ===============");
    Vtiger_Utils::CreateTable('vtiger_inventoryproductrel_equipment',
    '(
        `id` int(19) DEFAULT NULL,
        `lineitem_id` int(11) NOT NULL AUTO_INCREMENT,
        PRIMARY KEY (`lineitem_id`),
        KEY `vtiger_inventoryproductrel_equipment_id_idx` (`id`),
        CONSTRAINT `fk_crmid_vtiger_inventoryproductrel_equipment` FOREIGN KEY (`id`) REFERENCES `vtiger_crmentity` (`crmid`) ON DELETE CASCADE
...
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('daadcp_lineblock', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('daadcp_avail_sl_no', $invoiceModule);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'daadcp_avail_sl_no';
        $fieldInstance->column = 'daadcp_avail_sl_no';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = 'vtiger_inventoryproductrel_equipment';
        $fieldInstance->label = 'Sl No';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        ...
        $fieldInstance->quickcreate = 3;
        $fieldInstance->helpinfo = 'li_lg';
        $fieldInstance->displaytype = '6';
        $blockInstance->addField($fieldInstance);
    } else {
        echo "field is present -- daadcp_avail_sl_no Equipment --- <br>";
    }
} else {
    echo "Block Does not exits -- daadcp_lineblock in Equipment -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('daadcp_lineblock', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('daadcp_contra_lable', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'daadcp_contra_lable';
        $field->column = 'daadcp_contra_lable';
        $field->uitype = 2;
        $field->table = 'vtiger_inventoryproductrel_equipment';
        ...
        echo "field is present -- daadcp_contra_lable Equipment --- <br>";
    }
} else {
    echo "Block Does not exits -- daadcp_lineblock in Equipment -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('daadcp_lineblock', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('daadcp_avail_percent', $invoiceModule);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'daadcp_avail_percent';
        $fieldInstance->column = 'daadcp_avail_percent';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = 'vtiger_inventoryproductrel_equipment';
        $fieldInstance->label = 'Availability %';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        $fieldInstance->columntype = 'DECIMAL(7,3)';
...
$blockInstance = Vtiger_Block::getInstance('daadcp_lineblock', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('daadcp_avail_mon_percent', $invoiceModule);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'daadcp_avail_mon_percent';
        $fieldInstance->column = 'daadcp_avail_mon_percent';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = 'vtiger_inventoryproductrel_equipment';
        $fieldInstance->label = 'Monthly availability %';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        $fieldInstance->columntype = 'DECIMAL(7,3)';
        ...
        echo "field is present -- daadcp_avail_mon_percent Equipment --- <br>";
    }
} else {
    echo "Block Does not exits -- daadcp_lineblock in Equipment -- <br>";
}
...
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('hmr_kilo_info', $moduleInstance);
if ($blockInstance) {
    echo " block does not exits --- hmr_kilo_info   -- <br>";
} else {
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'hmr_kilo_info';
    $moduleInstance->addBlock($blockInstance);
}
$moduleInstance = null;
$blockInstance = null;
...
if ($blockInstance) {
    ...
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'SER_ENGG_DETAIL';
    $moduleInstance->addBlock($blockInstance);
}
$moduleInstance = null;
$blockInstance = null;
...
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('WSRAA', $moduleInstance);
if ($blockInstance) {
    echo " block does not exits --- WSRAA   -- <br>";
} else {
    $blockInstance = new Vtiger_Block();
    $blockInstance->label = 'WSRAA';
    $moduleInstance->addBlock($blockInstance);
}
$moduleInstance = null;
$blockInstance = null;
...
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('WSRAA', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('eq_wsraa', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'eq_wsraa';
        $field->column = 'eq_wsraa';
        $field->table = $invoiceModule->basetable.'cf';
        $field->label = 'eq_wsraa';
        $field->uitype = 56;
        $field->columntype = 'INT(1) DEFAULT 0';
        $field->typeofdata = 'I~O';
        $field->displaytype = 1;
        ...
        echo "field is present -- eq_wsraa In Equipment Module --- <br>";
    }
} else {
    echo "Block Does not exits -- WSRAA in Equipment -- <br>";
}
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('hmr_kilo_info', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('last_kilometer_date', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'last_kilometer_date';
        $fieldInstance->label = 'Last Kilometer Record Date';
        $fieldInstance->table = $moduleInstance->basetable.'cf';
        $fieldInstance->column = 'last_kilometer_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- last_kilometer_date in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- hmr_kilo_info -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('hmr_kilo_info', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('measuring_point', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'measuring_point';
        $fieldInstance->column = 'measuring_point';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable.'cf';
        $fieldInstance->label = 'Measuring Point';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'I~O';
        $fieldInstance->columntype = 'INT(15)';
        ...
        echo "field is already Present --- measuring_point in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- hmr_kilo_info in Equipment -- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
...
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('Equipment');
$blockInstance = Vtiger_Block::getInstance('hmr_kilo_info', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('measuring_point_desc', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'measuring_point_desc';
        $field->column = 'measuring_point_desc';
        $field->table = $invoiceModule->basetable.'cf';
        $field->label = 'Measuring Point Description';
        $field->uitype = 2;
        $field->columntype = 'VARCHAR(50)';
        $field->typeofdata = 'V~O';
        $field->displaytype = 1;
        ...
        echo "field is present -- measuring_point_desc In Equipment Module --- <br>";
    }
} else {
    echo "Block Does not exits -- hmr_kilo_info in Equipment -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- ser_eng_name in Equipment --- <br>";
    }
} else {
    echo "Block Does not exits -- SER_ENGG_DETAIL in Equipment -- <br>";
}
...
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('HelpDesk', 'AutoUpdateDaysfromCreateddate'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("HelpDesk", "AutoUpdateDaysfromCreateddate", "modules/HelpDesk/AutoUpdateDaysfromCreateddate.php", "AutoUpdateDaysfromCreateddate");
} else {
    print_r("already exits --- workflow function -- AutoUpdateDaysfromCreateddate <br> ");
}
...
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('Equipment', 'EquipmentAvailabilityCalculateOnEdit'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("Equipment", "EquipmentAvailabilityCalculateOnEdit", "modules/Equipment/EquipmentAvailabilityCalculateOnEdit.php", "EquipmentAvailabilityCalculateOnEdit");
} else {
    print_r("already exits --- workflow function -- EquipmentAvailabilityCalculateOnEdit in Equipment Module <br> ");
}
$emm = null;
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- shift_hours in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- Equipment Availability -- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_SYSTEM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('commited_avl_m_w', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'commited_avl_m_w';
        $fieldInstance->column = 'commited_avl_m_w';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Commited Monthly Availability %';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        $fieldInstance->columntype = 'DECIMAL(7,3)';
        ...
        echo "field is already Present --- commited_avl_m_w  in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_SYSTEM_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_SYSTEM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('less_than_commi_ava', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'less_than_commi_ava';
        $fieldInstance->label = 'Less Than Committed Availability';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'less_than_commi_ava';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        ...
        echo "field is already Present --- less_than_commi_ava in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_SYSTEM_INFORMATION -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is already Present --- run_year_cont in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_SYSTEM_INFORMATION in EquipmentAvailability -- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_ITEM_DETAILS', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('total_excluded_qty', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'total_excluded_qty';
        $fieldInstance->column = 'total_excluded_qty';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = 'vtiger_inventoryproductrel';
        $fieldInstance->label = 'Total Excluded Qty.';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'I~O';
        $fieldInstance->columntype = 'INT(15)';
        ...
        echo "field is already Present --- total_excluded_qty in FailedParts Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ITEM_DETAILS in FailedParts -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_ITEM_DETAILS', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('tot_excluded_qty_rem', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'tot_excluded_qty_rem';
        $field->column = 'tot_excluded_qty_rem';
        $field->uitype = 21;
        $field->table = 'vtiger_inventoryproductrel';
        $field->label = 'Total Excluded Qty- Remarks';
        $field->readonly = 1;
        $field->presence = 2;
        $field->typeofdata = 'V~O';
        $field->columntype = 'TEXT';
        ...
        echo "field is present -- tot_excluded_qty_rem In FailedParts Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_ITEM_DETAILS -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_TICKET_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('no_of_days', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'no_of_days';
        $fieldInstance->column = 'no_of_days';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Number of Days';
        $fieldInstance->summaryfield = 1;
                $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'I~O';
        ...
        echo "field is already Present --- no_of_days in HelpDesk Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_TICKET_INFORMATION in HelpDesk -- <br>";
}
...
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('Equipment', 'CalculateContractAndWarranty'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("Equipment", "CalculateContractAndWarranty", "modules/Equipment/CalculateContractAndWarranty.php", "CalculateContractAndWarranty");
} else {
    print_r("already exits --- workflow function -- CalculateContractAndWarranty in Equipment Module <br> ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('Equipment Availability', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('start_day_of_avail_calc', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'start_day_of_avail_calc';
        $fieldInstance->column = 'start_day_of_avail_calc';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = $moduleInstance->basetable."cf";
        $fieldInstance->label = 'Starting Day Of Availability Calculation';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'I~O';
        $fieldInstance->columntype = 'INT(5)';
        ...
        echo "field is already Present --- start_day_of_avail_calc in Equipment Module --- <br>";
    }
} else {
    echo " block does not exits --- Equipment Availability in Equipment -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'start_date';
        $fieldInstance->label = 'Start Date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'start_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- start_date in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_SYSTEM_INFORMATION -- <br>";
}
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'end_date';
        $fieldInstance->label = 'End Date';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'end_date';
        $fieldInstance->uitype = 5;
        $fieldInstance->displaytype = 3;
        $fieldInstance->typeofdata = 'D~O';
        $fieldInstance->columntype = 'DATE';
        ...
        echo "field is already Present --- end_date in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_SYSTEM_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_PRODUCT_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('store_code', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'store_code';
        $field->column = 'store_code';
        $field->uitype = 2;
        $field->table = $invoiceModule->basetable;
        ...
        echo "field is present -- store_code Products --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_PRODUCT_INFORMATION in Products -- <br>";
}
...
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('ServiceOrders', 'ExternalAppSyncUpdated'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("ServiceOrders", "ExternalAppSyncUpdated", "modules/ServiceOrders/ExternalAppSyncUpdated.php", "ExternalAppSyncUpdated");
} else {
    print_r("already exits --- workflow function -- ExternalAppSyncUpdated in ServiceOrders Module <br> ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('eq_customer_code', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'eq_customer_code';
        $field->column = 'eq_customer_code';
        $field->uitype = 2;
        $field->table = $invoiceModule->basetable.'cf';
        ...
        echo "field is present -- eq_customer_code in Equipment --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_BLOCK_GENERAL_INFORMATION in Equipment -- <br>";
}
...
if (Vtiger_Utils::CheckTable('vtiger_temp_so_table')) {
    print_r("================Table Exits vtiger_temp_so_table ===============");
}  else {
    print_r("================Table Does Not Exits vtiger_temp_so_table ===============");
    Vtiger_Utils::CreateTable('vtiger_temp_so_table',
    ' (
        `id` int(10) NOT NULL AUTO_INCREMENT,
        `soid` int(30) NOT NULL,
        `prod_desc` text COLLATE utf8_bin NOT NULL,
        `qty` decimal(10,3) NOT NULL,
        `part_number` varchar(250) COLLATE utf8_bin NOT NULL,
        PRIMARY KEY (`id`)
      ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_bin',false);
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_SYSTEM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('type_of_eq_availability', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'type_of_eq_availability';
        $fieldInstance->label = 'Type Of Availability';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'type_of_eq_availability';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        ...
        $fieldInstance->displaytype = 3;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('Month', 'Year'));
    } else {
        echo "field is already Present --- type_of_eq_availability in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_SYSTEM_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('Sub_Assembly_Spares_Parts_Details', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('saspd_ser_no', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'saspd_ser_no';
        $field->column = 'saspd_ser_no';
        $field->uitype = 2;
        $field->table = "vtiger_servicereports_other";
        $field->label = 'Serial No.';
        $field->readonly = 1;
        ...
        echo "field is present -- saspd_ser_no in ServiceReports --- <br>";
    }
} else {
    echo "Block Does not exits -- Sub_Assembly_Spares_Parts_Details in ServiceReports -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('Sub_Assembly_Commissioning_Fitment_details', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('sacfd_hmr_at_fitment', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'sacfd_hmr_at_fitment';
        $fieldInstance->column = 'sacfd_hmr_at_fitment';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = 'vtiger_servicereports_other';
        $fieldInstance->label = 'HMR at the time of Fitment';
        $fieldInstance->readonly = 1;
        ...
        echo "field is already Present --- sacfd_hmr_at_fitment in ServiceReports Module --- <br>";
    }
} else {
    echo " block does not exits --- Sub_Assembly_Commissioning_Fitment_details  in ServiceReports -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_GENERAL_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('hmr_entry_comment', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'hmr_entry_comment';
        $field->column = 'hmr_entry_comment';
        $field->uitype = 21;
        $field->table = $invoiceModule->basetable;
        $field->label = 'Comment';
        $field->readonly = 1;
        ...
        echo "field is present -- hmr_entry_comment  in HMREntries--- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_BLOCK_GENERAL_INFORMATION in HMREntries -- <br>";
}
...
if (Vtiger_Utils::CheckTable('vtiger_temp_sto_table')) {
    print_r("================Table Exits vtiger_temp_sto_table ===============");
}  else {
    print_r("================Table Does Not Exits vtiger_temp_sto_table ===============");
    Vtiger_Utils::CreateTable('vtiger_temp_sto_table',
    ' (
        `id` int(10) NOT NULL AUTO_INCREMENT,
        `stoid` varchar(30) NOT NULL,
        `prod_desc` text COLLATE utf8_bin NOT NULL,
        `qty` decimal(10,3) NOT NULL,
        `part_number` varchar(250) COLLATE utf8_bin NOT NULL,
        PRIMARY KEY (`id`)
...
$emm = null;
$emm = new VTEntityMethodManager($adb);
$result = $adb->pquery("SELECT function_name FROM com_vtiger_workflowtasks_entitymethod WHERE module_name=? AND method_name=?", array('HMREntries', 'UpdateHMROnCreate'));
if ($adb->num_rows($result) == 0) {
    $emm->addEntityMethod("HMREntries", "UpdateHMROnCreate", "modules/HMREntries/UpdateHMROnCreate.php", "UpdateHMROnCreate");
} else {
    print_r("already exits --- workflow function -- UpdateHMROnCreate in HMREntries Module <br> ");
}
$emm = null;
...
$blockInstance = Vtiger_Block::getInstance('LBL_ITEM_DETAILS', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('total_fail_pa_sb_qty', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'total_fail_pa_sb_qty';
        $fieldInstance->column = 'total_fail_pa_sb_qty';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = 'vtiger_inventoryproductrel';
        $fieldInstance->label = 'Total Submitted Qty.';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'I~O';
        $fieldInstance->columntype = 'INT(15)';
        ...
        echo "field is already Present --- total_fail_pa_sb_qty in FailedParts Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ITEM_DETAILS in FailedParts -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_ITEM_DETAILS', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('pending_qty_for_validation', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'pending_qty_for_validation';
        $fieldInstance->column = 'pending_qty_for_validation';
        $fieldInstance->uitype = 7;
        $fieldInstance->table = 'vtiger_inventoryproductrel';
        $fieldInstance->label = 'Total Pending Qty For Validation';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'I~O';
        $fieldInstance->columntype = 'INT(15)';
        ...
        echo "field is already Present --- pending_qty_for_validation in FailedParts Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ITEM_DETAILS in FailedParts -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_ITEM_DETAILS', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('submitted_qty_log', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'submitted_qty_log';
        $field->column = 'submitted_qty_log';
        $field->uitype = 21;
        $field->table = 'vtiger_inventoryproductrel';
        $field->label = 'Submitted Qty History';
        $field->readonly = 1;
        $field->presence = 2;
        $field->typeofdata = 'V~O';
        $field->columntype = 'TEXT';
        ...
        echo "field is present -- submitted_qty_log In FailedParts Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_ITEM_DETAILS -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_TICKET_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('not_valid_sr_remarks', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'not_valid_sr_remarks';
        $field->column = 'not_valid_sr_remarks';
        $field->uitype = 21;
        $field->table = 'vtiger_ticketcf';
        $field->label = 'Invalid Service Request Remarks';
        $field->readonly = 1;
        $field->presence = 2;
        $field->typeofdata = 'V~O';
        $field->columntype = 'TEXT';
        ...
        echo "field is present -- not_valid_sr_remarks In HelpDesk Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_TICKET_INFORMATION in HelpDesk -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('LBL_BLOCK_SYSTEM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('commited_avl_y', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'commited_avl_y';
        $fieldInstance->column = 'commited_avl_y';
        $fieldInstance->uitype = 9;
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->label = 'Commited Yearly Availability %';
        $fieldInstance->readonly = 1;
        $fieldInstance->presence = 2;
        $fieldInstance->typeofdata = 'N~O';
        $fieldInstance->columntype = 'DECIMAL(7,3)';
        ...
        echo "field is already Present --- commited_avl_y  in EquipmentAvailability Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_BLOCK_SYSTEM_INFORMATION -- <br>";
}
...
$blockInstance = Vtiger_Block::getInstance('SYSTEM INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('is_submitted', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'is_submitted';
        $field->column = 'is_submitted';
        $field->table = $invoiceModule->basetable;
        $field->label = 'Is Submitted';
        $field->uitype = 56;
        $field->columntype = 'INT(1) DEFAULT 0';
        $field->typeofdata = 'I~O';
        $field->displaytype = 3;
        ...
        echo "field is present -- is_submitted In ServiceReports Module --- <br>";
    }
} else {
    echo "Block Does not exits -- SYSTEM INFORMATION in ServiceReports -- <br>";
}
...
// Add Sub Category Field in HelpDesk Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('HelpDesk');
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'sub_category';
        $fieldInstance->label = 'Sub Category';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'sub_category';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        ...
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('Sub Category Not Selected', 'Electrical Shock'));
    } else {
        echo "field is already Present --- sub_category in HelpDesk Module --- <br>";
    }
} else {
    echo "Block does not exits --- LBL_CUSTOM_INFORMATION -- <br>";
}
...
// Add Complaint Type Field in HelpDesk Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('HelpDesk');
$blockInstance = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('complaint_type', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'complaint_type';
        $fieldInstance->label = 'Complaint Type';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'complaint_type';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('Demo', 'Email', 'Meeting', 'Phone', 'Service Request'));
    } else {
        echo "field is already Present --- complaint_type in HelpDesk Module --- <br>";
    }
} else {
    echo "Block does not exits --- LBL_CUSTOM_INFORMATION -- <br>";
}
...
// Add Complaint Source Field in HelpDesk Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('HelpDesk');
$blockInstance = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('complaint_source', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'complaint_source';
        $fieldInstance->label = 'Complaint Source';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'complaint_source';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('CALL CENTER', 'EMAIL', 'IVR', 'KIOSK', 'PANEL', 'SMS', 'WEB'));
    } else {
        echo "field is already Present --- complaint_source in HelpDesk Module --- <br>";
    }
} else {
    echo "Block does not exits --- LBL_CUSTOM_INFORMATION -- <br>";
}
...
// Add Reported On Field in HelpDesk Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('HelpDesk');
$blockInstance = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('reported_on', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'reported_on';
        $fieldInstance->label = 'Reported On';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'reported_on';
        $fieldInstance->uitype = '5';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(200)';
        ...
        echo "field is already Present --- reported_on in HelpDesk Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_CUSTOM_INFORMATION  in HelpDesk -- <br>";
}
...
// Add Due By (Deadline) Field in HelpDesk Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('HelpDesk');
$blockInstance = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('due_by', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'due_by';
        $fieldInstance->label = 'Due By (Deadline)';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'due_by';
        $fieldInstance->uitype = '5';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(200)';
        ...
        echo "field is already Present --- due_by in HelpDesk Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_CUSTOM_INFORMATION  in HelpDesk -- <br>";
}
...
// Add Enter Subject Field in HelpDesk Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('HelpDesk');
$blockInstance = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('enter_subject', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'enter_subject';
        $fieldInstance->label = 'Enter Subject';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'enter_subject';
        $fieldInstance->uitype = '2';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(200)';
        ...
        echo "field is already Present --- enter_subject in HelpDesk Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_CUSTOM_INFORMATION  in HelpDesk -- <br>";
}
...
// Add Problem Status Field in HelpDesk Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('HelpDesk');
$blockInstance = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('problem_status', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'problem_status';
        $fieldInstance->label = 'Problem Status';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'problem_status';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('Closed', 'Not Solved', 'Resolved'));
    } else {
        echo "field is already Present --- problem_status in HelpDesk Module --- <br>";
    }
} else {
    echo "Block does not exits --- LBL_CUSTOM_INFORMATION -- <br>";
}
...
// Add Preferred Timeslot Field in HelpDesk Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('HelpDesk');
$blockInstance = Vtiger_Block::getInstance('LBL_CUSTOM_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('preferred_timeslot', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'preferred_timeslot';
        $fieldInstance->label = 'Preferred Timeslot';
        $fieldInstance->table = $moduleInstance->basetable;
        $fieldInstance->column = 'preferred_timeslot';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~O';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('2 pm to 5 pm', '6 pm to 9 pm', '9 am to 12 noon', 'No Preferred Time'));
    } else {
        echo "field is already Present --- preferred_timeslot in HelpDesk Module --- <br>";
    }
} else {
    echo "Block does not exits --- LBL_CUSTOM_INFORMATION -- <br>";
}
...
// Add description Field in ServiceEngineer Module
$invoiceModule = null;
$blockInstance = null;
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('ServiceEngineer');
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        echo "field is present -- description In ServiceEngineer Module --- <br>";
    }
} else {
    echo "Block Does not exits -- LBL_USERLOGIN_ROLE in ServiceEngineer -- <br>";
}
...
// Add Zone Field in Contacts Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Contacts');
...
if ($blockInstance) {
    ...
    if (!$fieldInstance) {
        ...
        $fieldInstance->table = 'vtiger_contactaddress';
        ...
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array('Academic', 'Hostel', 'Residential'));
    } else {
        echo "field is already Present --- zone in Contacts Module --- <br>";
    }
} else {
...
// Add Area Field in Contacts Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Contacts');
$blockInstance = Vtiger_Block::getInstance('LBL_ADDRESS_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('area', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'area';
        $fieldInstance->label = 'Area';
        $fieldInstance->table = 'vtiger_contactaddress';
        $fieldInstance->column = 'area';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array("Aerospace", "BSB", "BioTech", "Applied Mechanics", "CFD Center", "Chemical Engg", "Computer Centre", "Chemistry", "Chemical Workshop", "CSB", "Dr. Deshpande Centre - CSD", "Composite Technology", "CLT", "KV School", "Main Guest House", "Mathematics", "Metallurgy", "Physics", "PRO Office", "DOMS", "Engineering Design", "Electrical Science Block ESB", "EWRE", "Fluid Dynamics / Mechanics", "GATE JEE BLOCK", "Humanities Science Block HSB", "HTML", "HTTP", "IC Engine Lab", "ICSR Building", "Kinetics Chemical Lab KCL", "Library", "MDS Block", "MES Block - Dr. Ranganathan Bldg", "Metallurgy Workshop", "Metal Forming Lab", "Mechanical Science Block MSB", "MSRC", "New NCCRD", "Ocean Engineering Dept", "R &amp; AC Lab", "RGD Lab", "SAIF", "Structural Engineering", "TTML", "Central Workshop", "Others", "DOST Block", "CEC - Central Electronics Center", "Lecture Hall", "Class Room Complex - CRC", "Academic Maintenance", "MRI - MRS Center", "TDCE - Thermo Dynamics", "Hospital", "Brahmaputra", "Cauvery", "Ganga", "Godavari", "Jamuna", "Krishna", "Mahanadhi", "Mandakini", "Narmada", "Swimming Pool", "Saraswathi", "Sarayu", "Sharavathi", "Sindhu", "Tamiraparani", "Tapti", "NCC", "SFC-Sharavati", "Tunga Hostel", "Alumni Association", "Taramani Guest House", "Alakananda", "Pamba", "Nilgris", "SFC-Gurunath", "HZ-Civil-Maintenance", "Zaitoon", "0wzone yard &amp; Biogas plant", "Bhadra Hostel", "Others", "Sabarmati", "Swarnamukhi", "Sports Complex", "OAT", "SAC", "CCW Office", "Himalaya", "Vindhya", "Block WQ", "Block B", "Block C", "Block C1", "Block C2", "Block D1", "Block E", "Block E1", "Block F", "Block G", "Block MOH", "Block MSQ", "Block SSQ", "Block Z", "Block A", "SBI", "Post Office", "Community Hall", "Shopping Center", "Block D", "Others", "Tech-Kids", "IN / OUT Gate"));
    } else {
        echo "field is already Present --- area in Contacts Module --- <br>";
    }
} else {
    echo "Block does not exits --- LBL_ADDRESS_INFORMATION -- <br>";
}
...
// Add House No Field in Contacts Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Contacts');
$blockInstance = Vtiger_Block::getInstance('LBL_ADDRESS_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('house_no', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'house_no';
        $fieldInstance->label = 'House No';
        $fieldInstance->table = 'vtiger_contactaddress';
        $fieldInstance->column = 'house_no';
        $fieldInstance->uitype = '2';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(50)';
        ...
        echo "field is already Present --- house_no in Contacts Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ADDRESS_INFORMATION  in Contacts -- <br>";
}
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;

// Add House Type Field in Contacts Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Contacts');
$blockInstance = Vtiger_Block::getInstance('LBL_ADDRESS_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('house_type', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'house_type';
        $fieldInstance->label = 'House Type';
        $fieldInstance->table = 'vtiger_contactaddress';
        $fieldInstance->column = 'house_type';
        $fieldInstance->uitype = '16';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(100)';
        $fieldInstance->defaultvalue = NULL;
        $blockInstance->addField($fieldInstance);
        $fieldInstance->setPicklistValues(array("Permanent", "Temporary"));
    } else {
        echo "field is already Present --- house_type in Contacts Module --- <br>";
    }
} else {
    echo "Block does not exits --- LBL_ADDRESS_INFORMATION -- <br>";
}
...
// Add Location ID Field in Contacts Module
$moduleInstance = null;
$blockInstance = null;
$fieldInstance = null;
$moduleInstance = Vtiger_Module::getInstance('Contacts');
$blockInstance = Vtiger_Block::getInstance('LBL_ADDRESS_INFORMATION', $moduleInstance);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('location_id', $moduleInstance);
    if (!$fieldInstance) {
        $fieldInstance = new Vtiger_Field();
        $fieldInstance->name = 'location_id';
        $fieldInstance->label = 'Location ID';
        $fieldInstance->table = 'vtiger_contactaddress';
        $fieldInstance->column = 'location_id';
        $fieldInstance->uitype = '2';
        $fieldInstance->presence = '0';
        $fieldInstance->typeofdata = 'V~M';
        $fieldInstance->columntype = 'VARCHAR(50)';
        ...
        echo "field is already Present --- location_id in Contacts Module --- <br>";
    }
} else {
    echo " block does not exits --- LBL_ADDRESS_INFORMATION  in Contacts -- <br>";
}
...
$fieldInstance = null;
$invoiceModule = Vtiger_Module::getInstance('Contacts');
$blockInstance = Vtiger_Block::getInstance('LBL_CONTACT_INFORMATION', $invoiceModule);
if ($blockInstance) {
    $fieldInstance = Vtiger_Field::getInstance('user_id', $invoiceModule);
    if (!$fieldInstance) {
        $field = new Vtiger_Field();
        $field->name = 'user_id';
        ...
        echo "field is present -- user_id in Contacts --- <br>";
    }
} else {
