    ...
    <div class="lineItemTableDiv">
        <table class="table table-bordered lineItemsTable" style = "margin-top:15px">
            ...
            <th colspan="{$COL_SPAN1}" class="lineItemBlockHeader">
                {assign var=REGION_LABEL value=vtranslate($ITEMBLOCKNAME, $MODULE_NAME)}
                    ...
                    <tr>
                        ...
                        {if $PRODUCT_VIEWABLE}
                            <td>
                                ...
                                {/if}
                                <h5><a class="fieldValue" href="index.php?module=ReturnSaleOrders&view=Edit&parent_line_itemid={$LINE_ITEM_DETAIL["igLineItemId$INDEX"]}&sale_order_id={$RECORD->get('id')}" target="_blank">Create Return SalesOrder</a></h5>
                            </td>
                        {/if}
