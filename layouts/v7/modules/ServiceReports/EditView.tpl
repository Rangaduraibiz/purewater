					...
					<div class='modal-overlay-footer clearfix'>
						<div class="row clearfix">
							<div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '>
								<button type='submit' class='btn btn-soft-success saveButton' onclick="document.getElementById('is_submitted').value = 0">{vtranslate('LBL_SAVE', $MODULE)}</button>&nbsp;&nbsp;
								<button type='submit' class='btn btn-soft-success saveButton' onclick="document.getElementById('is_submitted').value = 1">{vtranslate('Submit And Close', $MODULE)}</button>&nbsp;&nbsp;
