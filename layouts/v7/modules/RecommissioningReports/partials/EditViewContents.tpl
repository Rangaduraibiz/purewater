                    ...
                    <table class="table table-borderless blockData {if $BLOCK_LABEL eq 'LBL_ADDRESS_INFORMATION'} addressBlock{/if}">
                        ...
                        {foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
                            ...
                            {if $FIELD_MODEL->isEditable() eq true}
                                ...
                                <td id="{$FIELD_MODEL->getFieldName()}hideOrShowInputId" {if in_array($FIELD_MODEL->get('uitype'),array('19','69')) || $FIELD_NAME eq 'description' || $BLOCK_LABEL eq 'GENERAL_CHECKS'} class="fieldValue fieldValueWidth80" colspan="3" {assign var=COUNTER value=$COUNTER+1} {else} class="fieldValue" {/if}>
