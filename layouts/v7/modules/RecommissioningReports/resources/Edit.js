Inventory_Edit_Js("RecommissioningReports_Edit_Js", {
	...
	*/
	...
	dependencyWarrantyApplicable: function () {
		...
		self.lineItemsHolder.find('tr.' + self.lineItemDetectingClass).each(function (index, domElement) {
			var lineItemRow = jQuery(domElement);
			let val = lineItemRow.find('input:radio[data-extraname="sad_war_term_app"]').val();
			if (val == 'YES') {
		...
		self.lineItemsHolder.find('tr.' + self.lineItemDetectingClass).each(function (index, domElement) {
			var lineItemRow = jQuery(domElement);
			let val = lineItemRow.find('input:radio[data-extraname="sad_valid_sl_no"]').val();
			if (val == 'YES') {
	...
	InitialBlocking: function () {
		...
		for (let i = 0; i < noneditableKeysLength; i++) {
			$("input[name='" + noneditableKeys[i] + "']").attr('readonly', 'readonly');
			...
			// $('.'+ noneditableKeys[i]).addClass("select2-container-disabled");
			$('#RecommissioningReports_Edit_fieldName_' + noneditableKeys[i]).attr("readonly", 'readonly');
		}
	...
	External_damage_showAndHide: function () {
		$("#vis_chk_ext_damhideOrShowId").addClass("hide");
		$("#vis_chk_ext_damhideOrShowInputId").addClass("hide");
		$("#vis_chk_ext_dam_imghideOrShowInputId").addClass("hide");
		$("#vis_chk_ext_dam_imghideOrShowId").addClass("hide");
		$('input:radio[name="vis_chk_external_damages"]').change(function () {
			let val = $("input[name='vis_chk_external_damages']:checked").val();
			if (val == 'NO') {
				$("#vis_chk_ext_damhideOrShowId").addClass("hide");
				$("#vis_chk_ext_damhideOrShowInputId").addClass("hide");
				$("#vis_chk_ext_dam_imghideOrShowInputId").addClass("hide");
				...
				$("#vis_chk_ext_damhideOrShowId").removeClass("hide");
				$("#vis_chk_ext_damhideOrShowInputId").removeClass("hide");
				$("#vis_chk_ext_dam_imghideOrShowInputId").removeClass("hide");
				$("#vis_chk_ext_dam_imghideOrShowId").removeClass("hide");

			}
		});
	},
	HydraulicAndAirLeakages: function () {
		$("#vis_hyd_air_dam_imghideOrShowId").addClass("hide");
		$("#vis_hyd_air_dam_imghideOrShowInputId").addClass("hide");
		$("#vis_chk_hyd_airhideOrShowId").addClass("hide");
		$("#vis_chk_hyd_airhideOrShowInputId").addClass("hide");
		$('input:radio[name="vis_chk_hydraulic_air_leakages"]').change(function () {
			let val = $("input[name='vis_chk_hydraulic_air_leakages']:checked").val();
			if (val == 'NO') {
				$("#vis_chk_hyd_airhideOrShowId").addClass("hide");
				$("#vis_chk_hyd_airhideOrShowInputId").addClass("hide");
				$("#vis_hyd_air_dam_imghideOrShowId").addClass("hide");
				...
				$("#vis_chk_hyd_airhideOrShowId").removeClass("hide");
				$("#vis_chk_hyd_airhideOrShowInputId").removeClass("hide");
				$("#vis_hyd_air_dam_imghideOrShowId").removeClass("hide");
				$("#vis_hyd_air_dam_imghideOrShowInputId").removeClass("hide");
			}
		});
	},
	Lubrication: function () {
		$("#vis_chk_lub_remhideOrShowId").addClass("hide");
		$("#vis_chk_lub_remhideOrShowInputId").addClass("hide");
		$("#vis_lub_los_imghideOrShowId").addClass("hide");
		$("#vis_lub_los_imghideOrShowInputId").addClass("hide");
		$('input:radio[name="vis_chk_lubrication"]').change(function () {
			let val = $("input[name='vis_chk_lubrication']:checked").val();
			if (val == 'NO') {
				$("#vis_chk_lub_remhideOrShowId").addClass("hide");
				$("#vis_chk_lub_remhideOrShowInputId").addClass("hide");
				$("#vis_lub_los_imghideOrShowId").addClass("hide");
				...
				$("#vis_chk_lub_remhideOrShowId").removeClass("hide");
				$("#vis_chk_lub_remhideOrShowInputId").removeClass("hide");
				$("#vis_lub_los_imghideOrShowId").removeClass("hide");
				$("#vis_lub_los_imghideOrShowInputId").removeClass("hide");
			}
		});
	},
	OilLevels: function () {
		$("#vis_chk_oil_remhideOrShowId").addClass("hide");
		$("#vis_chk_oil_remhideOrShowInputId").addClass("hide");
		$("#vis_oil_lev_imghideOrShowInputId").addClass("hide");
		$("#vis_oil_lev_imghideOrShowId").addClass("hide");
		$('input:radio[name="vis_chk_oil_levels"]').change(function () {
			let val = $("input[name='vis_chk_oil_levels']:checked").val();
			if (val == 'NO') {
				$("#vis_oil_lev_imghideOrShowInputId").addClass("hide");
				$("#vis_oil_lev_imghideOrShowId").addClass("hide");
				$("#vis_chk_oil_remhideOrShowId").addClass("hide");
				...
				$("#vis_oil_lev_imghideOrShowInputId").removeClass("hide");
				$("#vis_oil_lev_imghideOrShowId").removeClass("hide");
				$("#vis_chk_oil_remhideOrShowId").removeClass("hide");
				$("#vis_chk_oil_remhideOrShowInputId").removeClass("hide");
			}
		});
	},
	WorklooseningofHardwares: function () {
		$("#vis_hyd_wrk_los_imghideOrShowId").addClass("hide");
		$("#vis_hyd_wrk_los_imghideOrShowInputId").addClass("hide");
		$("#vis_chk_wrk_loshideOrShowId").addClass("hide");
		$("#vis_chk_wrk_loshideOrShowInputId").addClass("hide");
		$('input:radio[name="vis_chk_work_loseing_hders"]').change(function () {
			let val = $("input[name='vis_chk_work_loseing_hders']:checked").val();
			if (val == 'NO') {
				$("#vis_hyd_wrk_los_imghideOrShowId").addClass("hide");
				$("#vis_hyd_wrk_los_imghideOrShowInputId").addClass("hide");
				$("#vis_chk_wrk_loshideOrShowId").addClass("hide");
				...
				$("#vis_hyd_wrk_los_imghideOrShowId").removeClass("hide");
				$("#vis_hyd_wrk_los_imghideOrShowInputId").removeClass("hide");
				$("#vis_chk_wrk_loshideOrShowId").removeClass("hide");
				$("#vis_chk_wrk_loshideOrShowInputId").removeClass("hide");
			}
		});
	},
	next: function () {
		...
		$(id).on('input', function (event) {
			...
			if (value.length > 0) {
				if (fieldName == 'sad_sub_ass_hmr') {
					...
					$("#RecommissioningReports_editView_fieldName_sacfd_km_run").val();
					$("#RecommissioningReports_editView_fieldName_sacfd_km_run").prop("disabled", true);
					$("#RecommissioningReports_editView_fieldName_sad_hmr").prop("disabled", false);
				} else {
					$("#sad_sub_ass_hmr" + rowNum).val('');
					$("#sad_sub_ass_hmr" + rowNum).prop("disabled", true);
					$("#RecommissioningReports_editView_fieldName_sad_hmr").val();
					$("#RecommissioningReports_editView_fieldName_sad_hmr").prop("disabled", true);
					$("#RecommissioningReports_editView_fieldName_sacfd_km_run").prop("disabled", false);
				}
			} else {
	...
	checkWarntableOrNot: function () {
		...
		let dateOfFitemnet = $("#RecommissioningReports_editView_fieldName_sad_dofcf").val();
	...
	checkWarntableOrNotKM: function () {
		...
		let fitMentKM = $("#RecommissioningReports_editView_fieldName_sad_km_run").val();
		if (fitMentKM == '' || fitMentKM == null || fitMentKM == undefined) {
			return 'm';
		}
		let presentKM = $("#RecommissioningReports_editView_fieldName_eq_present_km").val();
	...
	checkWarntableOrNotHMR: function () {
		...
		let fitMentHMR = $("#RecommissioningReports_editView_fieldName_sad_hmr").val();
		if (fitMentHMR == '' || fitMentHMR == null || fitMentHMR == undefined) {
			return 'm';
		}
		let presentHMR = $("#RecommissioningReports_editView_fieldName_eq_last_hmr").val();
	...
	registerAllWarrantableFunctions: function () {
		...
		jQuery("#RecommissioningReports_editView_fieldName_sad_dofcf").on('change', function (event) {
			self.oredCondition();
		});
		jQuery("#sad_sub_ass_km1").on('input', function (event) {
			self.oredCondition();
		});
		jQuery("#RecommissioningReports_editView_fieldName_eq_present_km").on('input', function (event) {
			self.oredCondition();
		});
		jQuery("#RecommissioningReports_editView_fieldName_sad_km_run").on('input', function (event) {
			self.oredCondition();
		});
		jQuery("#sad_sub_ass_hmr1").on('input', function (event) {
			self.oredCondition();
		});
		jQuery("#RecommissioningReports_editView_fieldName_eq_last_hmr").on('input', function (event) {
			self.oredCondition();
		});
	...
	handleOtherDependecy: function () {
		...
		jQuery('.mt_major_aggrts').on('change', function (event) {
			// let fieldName = $(this).data("fieldname");
			let value = event.target.value;
			...
			if (value == '') {
				...
				dataOf['module'] = 'RecommissioningReports';
				dataOf['action'] = 'GetAllAggregateInfo';
				...
				app.request.get({ data: dataOf }).then(function (err, response) {
					if (err == null) {
						...
						let tdElemnet = ""
						if (response.data.equip_ag_serial_no == undefined || response.data.equip_ag_serial_no == null) {
							tdElemnet = "<td></td>";
						} else {
							tdElemnet = "<td>" + response.data.equip_ag_serial_no + "</td>";
						}
						tdElemnet += "<td>" + value + "</td>";
						if (response.data.equip_ag_manu_fact == undefined || response.data.equip_ag_manu_fact == null) {
							tdElemnet += "<td></td>";
						} else {
							tdElemnet += "<td>" + response.data.equip_ag_manu_fact + "</td>";
						}
						if (response.data.eq_last_hmr == undefined || response.data.eq_last_hmr == null) {
							tdElemnet += "<td></td>";
						} else {
							tdElemnet += "<td>" + response.data.eq_last_hmr + "</td>";
						}
						if (response.data.eq_valid_from == undefined || response.data.eq_valid_from == null) {
							tdElemnet += "<td></td>";
						} else {
							tdElemnet += "<td>" + response.data.eq_valid_from + "</td>";
						}
						tdElemnet += "<td>" + "</td>";
	...
	phoneCountryCode: function () {
		var input = document.querySelector("#RecommissioningReports_editView_fieldName_phone"),
		...
		$(document).ready(function () {
			$('#RecommissioningReports_editView_fieldName_phone').attr('type', 'tel');
		});
	...
	optionDamage: function () {
		$("#RecommissioningReports_Edit_fieldName_fail_de_type_of_damage").removeClass("select2 select2-offscreen");

		$("#RecommissioningReports_Edit_fieldName_fail_de_type_of_damage").addClass("hide");
		var option = $("#RecommissioningReports_Edit_fieldName_fail_de_type_of_damage option");
		var data = [], temp = [];
		...
		$('input[name="fail_de_type_of_damage"]').select2({
			...
			$('#RecommissioningReports_Edit_fieldName_fail_de_type_of_damage option:selected').removeAttr('selected');
			for (let i = 0; i < myArray.length; i++) {
				$("#RecommissioningReports_Edit_fieldName_fail_de_type_of_damage option[value='" + myArray[i] + "']").attr("selected", "selected").trigger('change');;
			}
		});
		var optionsSelected = $('#RecommissioningReports_Edit_fieldName_fail_de_type_of_damage').val();
			...
			if (autofileValue[i].value != '') {
				...
				AppConnector.request(url).then(
					function (data) {
						if (data['success']) {
							console.log(data);
							console.log(data.result.data.label);
	...
	engine: function () {
		$('#genchk_oil_pressurehideOrShowId').addClass("hide");
		$('#genchk_oil_pressurehideOrShowInputId').addClass("hide");
		$('#genchk_oil_temperaturehideOrShowId').addClass("hide");
		$('#genchk_oil_temperaturehideOrShowInputId').addClass("hide");
		$('#genchk_coolant_temperaturehideOrShowId').addClass("hide");
		$('#genchk_coolant_temperaturehideOrShowInputId').addClass("hide");
		$('input:radio[name="genchk_engine"]').change(function () {
			if ($("input[name='genchk_engine']:checked").val() == 'Applicable') {
				$('#genchk_oil_pressurehideOrShowId').removeClass("hide");
				$('#genchk_oil_pressurehideOrShowInputId').removeClass("hide");
				$('#genchk_oil_temperaturehideOrShowId').removeClass("hide");
				$('#genchk_oil_temperaturehideOrShowInputId').removeClass("hide");
				$('#genchk_coolant_temperaturehideOrShowId').removeClass("hide");
				$('#genchk_coolant_temperaturehideOrShowInputId').removeClass("hide");
			} else {
				$('#genchk_oil_pressurehideOrShowId').addClass("hide");
				$('#genchk_oil_pressurehideOrShowInputId').addClass("hide");
				$('#genchk_oil_temperaturehideOrShowId').addClass("hide");
	...
	transmission: function () {
		$('#genchk_oil_pre_trhideOrShowId').addClass("hide");
		$('#genchk_oil_pre_trhideOrShowInputId').addClass("hide");
		$('#genchk_oil_tr_temhideOrShowId').addClass("hide");
		$('#genchk_oil_tr_temhideOrShowInputId').addClass("hide");
		$('input:radio[name="genchk_transmission"]').change(function () {
			if ($("input[name='genchk_transmission']:checked").val() == 'Applicable') {
				$('#genchk_oil_pre_trhideOrShowId').removeClass("hide");
				$('#genchk_oil_pre_trhideOrShowInputId').removeClass("hide");
				$('#genchk_oil_tr_temhideOrShowId').removeClass("hide");
				$('#genchk_oil_tr_temhideOrShowInputId').removeClass("hide");
			} else {
				$('#genchk_oil_pre_trhideOrShowId').addClass("hide");
				$('#genchk_oil_pre_trhideOrShowInputId').addClass("hide");
				$('#genchk_oil_tr_temhideOrShowId').addClass("hide");
	...
	brakeDependency: function () {
		$('#genchk_brk_oil_temhideOrShowId').addClass("hide");
		$('#genchk_brk_oil_temhideOrShowInputId').addClass("hide");
		$('#genchk_air_pressurehideOrShowId').addClass("hide");
		$('#genchk_air_pressurehideOrShowInputId').addClass("hide");

		$('input:radio[name="genchk_brake"]').change(function () {
			if ($("input[name='genchk_brake']:checked").val() == 'Applicable') {
				$('#genchk_brk_oil_temhideOrShowId').removeClass("hide");
				$('#genchk_brk_oil_temhideOrShowInputId').removeClass("hide");
				$('#genchk_air_pressurehideOrShowId').removeClass("hide");
				$('#genchk_air_pressurehideOrShowInputId').removeClass("hide");
			} else {
				$('#genchk_brk_oil_temhideOrShowId').addClass("hide");
				$('#genchk_brk_oil_temhideOrShowInputId').addClass("hide");
				$('#genchk_air_pressurehideOrShowId').addClass("hide");
	...
	electricalDependency: function () {
		$('#genchk_motorhideOrShowId').addClass("hide");
		$('#genchk_motorhideOrShowInputId').addClass("hide");
		$('#genchk_battery_voltagehideOrShowId').addClass("hide");
		$('#genchk_battery_voltagehideOrShowInputId').addClass("hide");
		$('#genchk_hi_volt_ele_systemhideOrShowId').addClass("hide");
		$('#genchk_hi_volt_ele_systemhideOrShowInputId').addClass("hide")
		$('#genchk_auto_electrical_systemhideOrShowId').addClass("hide");
		$('#genchk_auto_electrical_systemhideOrShowInputId').addClass("hide");
		$('#genchk_field_switchhideOrShowId').addClass("hide");
		$('#genchk_field_switchhideOrShowInputId').addClass("hide");
		$('#genchk_transformerhideOrShowId').addClass("hide");
		$('#genchk_transformerhideOrShowInputId').addClass("hide");

		$('input:radio[name="genchk_electrical"]').change(function () {
			if ($("input[name='genchk_electrical']:checked").val() == 'Applicable') {
				$('#genchk_motorhideOrShowId').removeClass("hide");
				$('#genchk_motorhideOrShowInputId').removeClass("hide");
				$('#genchk_battery_voltagehideOrShowId').removeClass("hide");
				$('#genchk_battery_voltagehideOrShowInputId').removeClass("hide");
				$('#genchk_hi_volt_ele_systemhideOrShowId').removeClass("hide");
				$('#genchk_hi_volt_ele_systemhideOrShowInputId').removeClass("hide")
				$('#genchk_auto_electrical_systemhideOrShowId').removeClass("hide");
				$('#genchk_auto_electrical_systemhideOrShowInputId').removeClass("hide");
				$('#genchk_field_switchhideOrShowId').removeClass("hide");
				$('#genchk_field_switchhideOrShowInputId').removeClass("hide");
				$('#genchk_transformerhideOrShowId').removeClass("hide");
				$('#genchk_transformerhideOrShowInputId').removeClass("hide");
			} else {
				$('#genchk_motorhideOrShowId').addClass("hide");
				$('#genchk_motorhideOrShowInputId').addClass("hide");
				$('#genchk_battery_voltagehideOrShowId').addClass("hide");
	...
	hydralicDynamic: function () {
		$('#genchk_suspensionhideOrShowId').addClass("hide");
		$('#genchk_suspensionhideOrShowInputId').addClass("hide");
		$('#genchk_cylindershideOrShowId').addClass("hide");
		$('#genchk_cylindershideOrShowInputId').addClass("hide");
		$('#genchk_oil_coolerhideOrShowId').addClass("hide");
		$('#genchk_oil_coolerhideOrShowInputId').addClass("hide");
		$('#genchk_pumpshideOrShowId').addClass("hide");
		$('#genchk_pumpshideOrShowInputId').addClass("hide");
		$('input:radio[name="genchk_hydraulic"]').change(function () {
			if ($("input[name='genchk_hydraulic']:checked").val() == 'Applicable') {
				$('#genchk_suspensionhideOrShowId').removeClass("hide");
				$('#genchk_suspensionhideOrShowInputId').removeClass("hide");
				$('#genchk_cylindershideOrShowId').removeClass("hide");
				$('#genchk_cylindershideOrShowInputId').removeClass("hide");
				$('#genchk_oil_coolerhideOrShowId').removeClass("hide");
				$('#genchk_oil_coolerhideOrShowInputId').removeClass("hide");
				$('#genchk_pumpshideOrShowId').removeClass("hide");
				$('#genchk_pumpshideOrShowInputId').removeClass("hide");
			} else {
				$('#genchk_suspensionhideOrShowId').addClass("hide");
				$('#genchk_suspensionhideOrShowInputId').addClass("hide");
				$('#genchk_cylindershideOrShowId').addClass("hide");
	...
	breakdownYesorNo: function () {
		$('#breack_ticket_idhideOrShowId').addClass("hide");
		$('#breack_ticket_idhideOrShowInputId').addClass("hide");

		$('input:radio[name="at_brkdn_sr_req"]').change(function () {
			if ($("input[name='at_brkdn_sr_req']:checked").val() == 'Yes') {
				$('#breack_ticket_idhideOrShowId').removeClass("hide");
				$('#breack_ticket_idhideOrShowInputId').removeClass("hide");
			} else {
				$('#breack_ticket_idhideOrShowId').addClass("hide");
				$('#breack_ticket_idhideOrShowInputId').addClass("hide");
			}
	...
	offroad: function () {
		$('#at_brkdn_sr_reqhideOrShowId').addClass("hide");
		$('#at_brkdn_sr_reqhideOrShowInputId').addClass("hide");
		$('[data-fieldname="eq_sta_aft_act_taken"]').on('change', function () {
			if ($(this).val() == "Off Road") {
				$('#at_brkdn_sr_reqhideOrShowId').removeClass("hide");
				$('#at_brkdn_sr_reqhideOrShowInputId').removeClass("hide");
			} else {
				$('#at_brkdn_sr_reqhideOrShowId').addClass("hide");
				$('#at_brkdn_sr_reqhideOrShowInputId').addClass("hide");
