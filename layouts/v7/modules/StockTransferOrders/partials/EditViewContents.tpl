...
<div name='editContent' style="padding-top: 30px;">
    ...
    {if $EXTERNALERRORISTHERE}
		<div class="fieldBlockContainer duplicationMessageContainer">
			<div class="duplicationMessageHeader"><b>StockTransferOrders Is Created/Updated In CRM, But Sync To SAP , Has Failed , Please Fix Following Errors</b></div>
                    ...
                    {/if}
                     ...
                     {foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
                         ...
                         {if $FIELD_MODEL->isEditable() eq true}
                             ...
                             {/if}
                             <td id="{$FIELD_MODEL->getFieldName()}hideOrShowId" class="fieldLabel alignMiddle">
                         ...
                         <td id="{$FIELD_MODEL->getFieldName()}hideOrShowInputId" {if in_array($FIELD_MODEL->get('uitype'),array('19','69')) || $FIELD_NAME eq 'description'} class="fieldValue fieldValueWidth80" colspan="3" {assign var=COUNTER value=$COUNTER+1} {else} class="fieldValue" {/if}>
...
{include file="partials/LineItemsEdit1.tpl"|@vtemplate_path:'StockTransferOrders'}
{include file="partials/LineItemsEdit.tpl"|@vtemplate_path:'StockTransferOrders'}