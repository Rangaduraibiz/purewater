            ...
            <tbody>
                <tr>
                    ...
                    {foreach key=LINEITEM_CUSTOM_FIELDKEY item=LINEITEM_CUSTOM_FIELD from=$LINEITEM_CUSTOM_FIELDS}
                        ...
                        <!--add inline item fields in detailview purvesh-->
                        {if $LINEITEM_CUSTOM_FIELD['fieldlabel'] eq 'Present Status' or $LINEITEM_CUSTOM_FIELD['fieldlabel'] eq 'Action Taken by DSM'}
                            <td><strong> {$LINEITEM_CUSTOM_FIELD['fieldlabel']} Qty </strong></td>
                            {/if}
                    {/foreach}
                </tr>
                                ...
                                {if $LINEITEM_CUSTOM_FIELD['fieldlabel'] eq 'Present Status'}
                                    {foreach key=SUB_LINEITEM_CUSTOM_FIELDKEY item=SUB_LINEITEM_CUSTOM_FIELD from=$SUB_LINEITEM_CUSTOM_FIELDS}
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <label style="white-space: nowrap;margin-top:2px;">{$subfieldLabel}</label>
                                                </td>
                                            </tr>
                                        </table>
                                    {/foreach}
                                ...
                                {if $LINEITEM_CUSTOM_FIELD['fieldlabel'] eq 'Action Taken by DSM'}
                                    {foreach key=SUB2_LINEITEM_CUSTOM_FIELDKEY item=SUB2_LINEITEM_CUSTOM_FIELD from=$SUB2_LINEITEM_CUSTOM_FIELDS}
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <label style="white-space: nowrap;margin-top:2px;">{$sub2fieldLabel}</label>
                                                </td>
                                            </tr>
                                        </table>
                                    {/foreach}
                                        ...
                                        <div id="{$subfieldName}DivCla">
                                            <table>
                                                <tr style="margin-top:2px;">
                                                    <td><label>{$LINE_ITEM_DETAIL["$subfieldName$INDEX"]}</label></td>
                                                </tr>
                                            </table>
                                        <div>
                                    {/foreach}
                                    ...
                                    {foreach key=SUB2_LINEITEM_CUSTOM_FIELDKEY item=SUB2_LINEITEM_CUSTOM_FIELD from=$SUB2_LINEITEM_CUSTOM_FIELDS}
                                        ...
                                        <table>
                                            <tr style="margin-top:12px;">
                                                <td><strong>{$LINE_ITEM_DETAIL["$sub2fieldName$INDEX"]}</strong></td>
                                            </tr>
                                        </table>
                                    {/foreach}
                                </td>
